...
namespace Display.Views.More.DatumList.VideoDisplay;
...
public sealed partial class MainPage : Page,IDisposable
{
    ...
    /// <returns></returns>
    private async System.Threading.Tasks.Task DeletedFileFrom115Async(FilesInfo fileInfo)
    {
        // 首先，从播放列表中删除
    ...
    /// </summary>
    /// <returns></returns>
    private async System.Threading.Tasks.Task TryRemoveCurrentVideoAndPlayNextVideo(FilesInfo removeFileInfo)
    {
        // 即将删除的视频所属控件
