...
public interface IFileInfoDao : IBaseDao<FileInfo>
{
    ...
    /// <returns></returns>
    Task<List<FileInfo>> GetAllFilesListByFolderIdAsync(long folderId);
    ...
    /// <returns></returns>
    List<FileInfo> GetPartFolderListByPid(long pid, int? limit = null);
    ...
    /// <returns></returns>
    List<FileInfo> GetPartFileListByPid(long folderId, int? limit = null); 
    ...
    /// <param name="pickCode"></param>
    /// <returns></returns>
    FileInfo? GetOneByPickCode(string pickCode);
    
    
    FileInfo? GetUpperLevelFolderInfoByFolderId(long id);
    ...
    /// <returns></returns>
    List<FileInfo> GetFolderListToRootByFolderId(long folderCid);
    ...
    List<FileInfo> GetFileInfoListByVideoInfoId(long infoId);
}